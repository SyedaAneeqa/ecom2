...
//     name: '',
//     category: 'Dresses', // Default value
//     gender: 'Women',     // Default value
//     availableSizes: 's,m,l,xl', // Input as a comma-separated string
//     retailPrice: '',
//     actualCost: '',
//     color: '',
//     collection: 'Default',
...
//     // Prepare data: convert comma-separated sizes string to an array
//     const productData = {
//       ...formData,
...
//     try {
//       // POST request to your API to create a new product
...
//       setError('Failed to add product. Check the API server response.');
//       setLoading(false);
//     }
//   };
...
//               <label className="block">
//                 <span className="text-gray-700">Image URL * (Example: https://...)</span>
//                 <input 
//                   type="url" 
//                   name="img" 
//                   value={formData.img} 
...
//                   <option>Pants</option>
//                   {/* Add all categories from your filters here */}
//                 </select>
//               </label>
